...
<div class="template_about_page_container">
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder" style="display: block">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/Jillian.jpeg" alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="history_text" style="display: block">
                                <p>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/Dj-andcast.jpeg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/David and Jillian.jpeg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/MSND 05.jpeg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/Lumina front porch.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/Jillian-2.jpeg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/The Blackjacks.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/Boss John.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/Screen Shot 2020-11-12 at 8.37.03 PM.png" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="info_holder">
                            <div class="title_holder">
                                <div class="featured_image_holder">
                                    <div class="image_holder">
                                        <div class="image">
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/dev/SPOON.JPG" alt="">
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="team_section">
            ...
            <div class="members">
                    <div class="member_holder">
                        <div class="member">
                            ...
                            <p class="member_title">Director Emeritus</p>
                        </div>
                    </div>
                    ...
                    <div class="member_holder">
                        <div class="member">
                            ...
                            <p class="member_title">Managing Director Emeritus</p>
                        </div>
                    </div>
                    ...
                    <div class="member_holder">
                        <div class="member">
                            ...
                            <p class="member_title">Founder and Guiding Light</p>
                        </div>
                    </div>
            </div>
        </div>
        ...
        <div class="directors">
            ...
            <ul>
                <li>Clare Lefebure</li>
                <li>Michael Novello</li>
                <li>Cindy Ross-Zenick</li>
