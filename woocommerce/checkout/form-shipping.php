...
<div class="woocommerce-shipping-fields">
	<?php if ( true === WC()->cart->needs_shipping_address() ) : ?>
        ...
        <div class="pills_checkbox_inputs_holder">
            ...
            <label for="test_2" class="container">
                <input type="radio" id="test_2" name="ship_to_different_address_radio" value="no" <?php checked( apply_filters( 'woocommerce_ship_to_different_address_checked', 'shipping' === get_option( 'woocommerce_ship_to_destination' ) ? 1 : 0 ), 1 ); ?>>
                <span class="checkmark">Use a different shipping address</span>
            </label>
        </div>
