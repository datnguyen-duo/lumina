    ...
    <div class="top">
        ...
        <div class="right">
            ...
            <div class="social_media">
                ...
                <ul>
                    <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/social-media/facebook.svg" alt=""></a></li>
                    <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/social-media/instagram.svg" alt=""></a></li>
                    <li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/images/social-media/youtube.svg" alt=""></a></li>
                </ul>
            </div>
        </div>
    </div>
