    ...
    $(".ticket_variations_form").each(function () {
      ...
      $(formEl).validate({
        ...
        submitHandler: function (form) {
          ...
          var variationID = $(formEl)
            .find("select[name=ticket-date-time]")
            .val();
          ...
          var ticketType = $(
            "#ticket_type_" + itemID + " option:selected"
          ).text();
            ...
            success: function (data) {
              ...
              if (data === "false") {
                document.getElementById(responseEl).innerHTML =
                  "Tickets for this date are out of stock!";
                ...
                let word = parseInt(info[1]) > 1 ? "tickets" : "ticket";
                document.getElementById(responseEl).innerHTML =
                  "There is no more available tickets for this date. You have last " +
                  word +
                  " in your cart.";
              } else {
                document.getElementById(responseEl).innerHTML = "";
